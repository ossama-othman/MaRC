...
bool test_vector_comparison()
{
    ...
    // Floating point typed vectors.
    using float_vector_type = MaRC::Vector<float, 4>;

    float_vector_type const v5{ 0, 1.2, 3.4, 5.6 };
    float_vector_type const v6{v5};

    float_vector_type v7{v5};
    v7[0] +=
        std::numeric_limits<float_vector_type::value_type>::epsilon();

    return v2 == v1 && v3 == v2 && v4 != v1 && v5 == v6 && v5 != v7;
}
